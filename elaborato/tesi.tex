...
\begin{document}
    ...
    Questo automa riconosce stringhe come \texttt{<}, \texttt{<>}, \texttt{<{<}<>} ma non riconosce \texttt{>}, poiché quest'ultima farebbe transitare l'automa nello stato di errore $q_{\text{err}}$.
