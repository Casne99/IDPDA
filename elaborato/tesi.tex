...
\begin{document}
    ...
    Per illustrare il funzionamento di un automa input driven deterministico più complesso, consideriamo un esempio che include anche simboli neutri. L'automa seguente riconosce stringhe bilanciate con simboli neutri interni:
