...
\begin{document}
    ...
    In ambito applicativo, esso riveste particolare importanza in contesti quali il parsing robusto, il riconoscimento di input rumorosi e i sistemi di correzione automatica.
    ...
    La famiglia dei linguaggi riconosciuti da un IDPDA è chiusa rispetto a questa operazione, ovvero se $L$ è un linguaggio riconosciuto da un IDPDA, allora anche il suo \textit{k}-vicinato è riconosciuto da un IDPDA. \\
    ...
    un altro IDPDA che riconosce il vicinato del linguaggio $L$, trattando separatamente i sei casi di inserimento, cancellazione e sostituzione per ogni tipo di simbolo dell'alfabeto (parentesi sinistre, destre e simboli neutri).
...
% OR gates
    ...
    Questo aspetto evidenzia come il problema della distanza di edit non sia soltanto uno strumento applicativo per la correzione di input rumorosi, ma anche un punto di incontro tra teoria degli automi, parsing e teoria della complessità.
