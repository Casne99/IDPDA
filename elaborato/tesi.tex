...
\begin{document}
    ...
    \subsubsection{Esempio 1: \textsc{Controllo di blocchi sovrapposti}}

    Il problema \textsc{Controllo di blocchi sovrapposti} prevede di determinare se, in una stringa binaria, ogni coppia di bit consecutivi contiene almeno un valore $1$.
    ...
    Segue che \textsc{Controllo di blocchi sovrapposti} $\in \mathbf{AC^0}$.
