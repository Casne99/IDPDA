...
% OR gates
    ...
    le distanze di edit per una classe di linguaggi posta tra i linguaggi context-free ed i linguaggi context-sensitive, ovvero la classe dei linguaggi accettati da specifici automi input-driven non deterministici 1-NAuxPDA~\cite{brandeburg}. \\
    ...
    \begin{thebibliography}{9}
        ...
        \textit{Complexity of Input-Driven Pushdown Automata, ACM SIGACT News, vol. 45, no. 2}.
        \bibitem{pighizzini}
        Giovanni Pighizzini (2001),
        \textit{How Hard Is Computing the Edit Distance? Information and Computation 165, 1-13}.
        \bibitem{Karp 1}
        Karp, R. (1972),
        ...
        \bibitem{mcnaughton}
        R. McNaughton (1967),
        \textit{Parenthesis grammars, Journal of the ACM, 14:3, 490-500}.
        \bibitem{neighborhood}
        Alexander Okhotin, Kai Salomaa (2019),
        \textit{Edit distance neighbourhoods of input-driven pushdown automata, Theoretical Computer Science 777, 417-430}.
