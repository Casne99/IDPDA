...
% OR gates
    ...
    Inoltre è stato osservato che il linguaggio $L_{acc}$ è accettato da un automa pushdown deterministico a due vie.
    Segue quindi che:

    \begin{prop}
        Esiste un linguaggio $L$ accettato da un automa pushdown deterministico a due vie tale che che $P = NP$ se e solo se
