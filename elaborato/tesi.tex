...
% OR gates
    ...
    In particolare abbiamo identificato la classe di linguaggi più ampia per cui è noto un algoritmo efficiente per il calcolo della distanza di edit, ovvero la classe dei linguaggi accettati da automi 1-NAuxPDA\@.
