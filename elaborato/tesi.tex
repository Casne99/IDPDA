...
\begin{document}
    ...
    \begin{itemize}
        \item $\Sigma_{+1}$: parentesi sinistre, determinano un'operazione di push sulla pila
    ...
    \begin{definition}
        ...
        \begin{itemize}
            ...
            \item $\delta_{<} : Q \rightarrow Q \times \Gamma$ è la funzione di transizione che, per ogni parentesi sinistra $< \in \Sigma_{+1}$, dato un determinato stato corrente, fornisce lo stato successivo e il simbolo da pushare sulla pila
    ...
    Questo automa riconosce stringhe come $<$, $<>$, $<<<>$ ma non riconosce $>$, poiché quest'ultima farebbe transitare l'automa nello stato di errore $q_{\text{err}}$.
