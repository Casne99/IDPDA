...
\begin{document}
    ...
    \subsubsection{Esempio di problema appartenente a $P$}
    ...
    \subsubsection{Esempio di problema appartenente a $PSPACE$}
    ...
    \subsubsection{Esempio di problema appartenente a $NP$}
...
% OR gates
    ...
    Nella trattazione che segue si farà riferimento a $\textit{co-NTIME(log n)} \in \mathbf{AC^0}$
    \clearpage
    %TODO: va tenuto?%
