...
\begin{document}
    ...
    Tale misura è alla base del \emph{correction problem}, che richiede non solo di determinare quanto un input sia distante dal linguaggio, ma anche di individuare una stringa del linguaggio che realizzi tale distanza minima.
