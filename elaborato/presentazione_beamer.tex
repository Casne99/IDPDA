...
\begin{itemize}
  ...
  \item La classe dei linguaggi riconosciuti da automi input-driven (1-NAuxPDA) è la più ampia per cui si conosce un algoritmo efficiente per il calcolo della distanza di edit.
\end{itemize}
\end{frame}
